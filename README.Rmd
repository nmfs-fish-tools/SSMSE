...
This package was developed to increase the ease of using Stock Synthesis (SS) directly as an operating model (OM) in an Management Strategy Evaluation (MSE). The approach requires a conditioned Stock Synthesis mode to use as the OM.
