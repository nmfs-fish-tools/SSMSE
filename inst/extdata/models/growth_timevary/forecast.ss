...
#C fleet-specific entries will need modification
...
#_Bmark_years: beg_bio, end_bio, beg_selex, end_selex, beg_relF, end_relF, beg_recr_dist, end_recr_dist, beg_SRparm, end_SRparm (enter actual year, or values of 0 or -integer to be rel. endyr)
 2009 2009 2009 2009 2009 2009 1960 2009 1960 2009
...
-1 #_Forecast loop control #4 (reserved for future bells&whistles) 
-1 #_Forecast loop control #5 (reserved for future bells&whistles) 
2004  #FirstYear for caps and allocations (should be after years with fixed inputs) 
