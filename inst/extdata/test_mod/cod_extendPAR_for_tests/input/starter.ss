...
#C file write time: 2020-04-08 10:52:27
data.ss
control.ss
...
101 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs
0 # N individual STD years 
#vector of year values 

0.1 # final convergence criteria (e.g. 1.0e-04) 
0 # retrospective year relative to end year (e.g. -4)
1 # min age for calc of summary biomass
0 # Depletion basis:  denom is: 0=skip; 1=rel X*SPB0; 2=rel SPBmsy; 3=rel X*SPB_styr; 4=rel X*SPB_endyr
...
0 # Annual_F_units: 0=skip; 1=exploitation(Bio); 2=exploitation(Num); 3=sum(Apical_F's); 4=true F for range of ages; 5=unweighted avg. F for range of ages
#COND 10 15 #_min and max age over which average F will be calculated with F_reporting=4 or 5
0 # F_std_basis: 0=raw_annual_F; 1=F/Fspr; 2=F/Fmsy ; 3=F/Fbtgt; where F means annual_F
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1586368358
