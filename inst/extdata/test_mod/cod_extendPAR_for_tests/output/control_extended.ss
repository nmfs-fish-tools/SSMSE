...
# Sex: 1  BioPattern: 1  NatMort
 0.01 1.8 0.2 0.1 0.8 0 -3 0 2 101 110 -1 0 0 # NatM_p_1_Fem_GP_1
...
#_no timevary MG parameters
 -10 10 1 1 1 0 -1 # NatM_p_1_Fem_GP_1_dev_se
 -10 10 1 1 1 0 -1 # NatM_p_1_Fem_GP_1_dev_autocorr
#
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn #  parm_name
             4            20       18.7123          10.3            10             0          1          0          2        101        110         -1          0          0 # SR_LN(R0)
           0.2             1          0.65           0.7          0.05             0         -4          0          0          0          0          0          0          0 # SR_BH_steep
             0             2           0.4           0.8           0.8             0         -5          0          0          0          0          0          0          0 # SR_sigmaR
            -5             5             0             0             1             0         -4          0          0          0          0          0          0          0 # SR_regime
             0             0             0             0             0             0        -99          0          0          0          0          0          0          0 # SR_autocorr
#_no timevary SR parameters
 -10 10 1 1 1 0 -1 # SR_LN(R0)_dev_se
 -10 10 1 1 1 0 -1 # SR_LN(R0)_dev_autocorr
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
           -20            20     0.0207708             0            99             0          5          0          2        101        110         -1          0          0  #  LnQ_base_Survey(2)
#_no timevary Q parameters
 -10 10 1 1 1 0 -1 # LnQ_base_Survey(2)_dev_se
 -10 10 1 1 1 0 -1 # LnQ_base_Survey(2)_dev_autocorr
#
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
# 1   Fishery LenSelex
          5.08         101.6       52.7944          50.8          0.05             0          2          0          2        101        110         -1          0          0  #  Size_DblN_peak_Fishery(1)
...
#_no timevary selex parameters
 -10 10 1 1 1 0 -1 # Size_DblN_peak_Fishery(1)_dev_se
 -10 10 1 1 1 0 -1 # Size_DblN_peak_Fishery(1)_dev_autocorr
#
