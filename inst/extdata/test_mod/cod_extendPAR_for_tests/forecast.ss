...
104  #FirstYear for caps and allocations (should be after years with fixed inputs) 
...
3 # basis for input Fcast catch: -1=read basis with each obs; 2=dead catch; 3=retained catch; 99=input apical_F; NOTE: bio vs num based on fleet's catchunits
#enter list of Fcast catches or Fa; terminate with line having year=-9999
#_Yr Seas Fleet Catch(or_F)
 101 1 1 9.90223e+007
-9999 1 1 0 
#
