...
SSMSE allows users to directly use [Stock Synthesis](https://vlab.noaa.gov/web/stock-synthesis) (SS3) as an operating model (OM) in a [Management Strategy Evaluation (MSE)](https://doi.org/10.1139/cjfas-2019-0084). The approach requires a conditioned Stock Synthesis model, which is treated as the OM.
...
6. Determine if more years need to be projected. If yes, continue; if no, end simulation.
7. Repeat steps 3-6.
