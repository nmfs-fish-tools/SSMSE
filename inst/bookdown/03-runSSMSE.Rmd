...
* `"all"` - Apply the change to all parameters in the model, with the exception of R0 and regime parameters (changing these would conflict with allowing changes to recruitment deviations). The change also applies to implementation error.
