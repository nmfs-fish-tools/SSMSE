...
* ts_param: This is the parameter to  modify. Options are "mean", "ar_1_q_param" (if using autocorrelation), "sd", and "cv". *(note: make sure cv is implemented)* If not included in the dataframe, "mean" is assumed to be the same as in the previous model year, sd is assumed to be 0, and we assume no autocorrelation (as specified through an autoregsive AR1 process).
