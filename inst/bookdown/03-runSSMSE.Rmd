...
The operating model (OM) for SSMSE should be a Stock Synthesis model. This could be any fitted Stock dSynthesis model. There is one built-in OM that comes with SSMSE, which is a cod-like model. To use the cod model in run_SSMSE, set `OM_name_vec = "cod"`. Otherwise, the path to the OM model should be specified in `OM_in_dir_vec`.
