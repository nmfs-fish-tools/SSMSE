...
test_that("change_yrs_fcast works/errors with allocation as expected", {
  ...
  fore[["fleet_assignment_to_allocation_group"]] <- data.frame(Fleet = 1:3,
                                                               Group = c(1, 1, 2))
  ...
  fore[["allocation_among_groups"]] <- data.frame(Year = c(endyr - 3, endyr - 2),
                                                  `Group 1` = c(0.25, 0.75),
                                                  `Group 2` = c(0.75, 0.25))
  expect_error(change_yrs_fcast(fore,
    ...
    fixed = TRUE)
  fore[["ForeCatch"]] <- data.frame(Year = 101:102, Seas = 1, Fleet = 1:2,
                                    Catch = c(200, 300))
