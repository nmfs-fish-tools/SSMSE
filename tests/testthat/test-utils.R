...
test_that("create_scen_list works as expected", {
  ...
  scen_list_out <- create_scen_list(
...
test_that("create_out_dirs works as expected with no EM", {
  ...
  expect_warning(mod_3_repeat <- create_out_dirs(
    out_dir = out_dir,
    niter = 3,
    OM_name = "custom_cod",
    OM_in_dir = cod_OM_dir
