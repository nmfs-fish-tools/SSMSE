...
RatioBiasEM <- function(EM_out_dir = NULL, init_loop = TRUE, OM_dat, verbose = FALSE,
  ...
  if(!is.null(new_OM_catch_list$catch)){
    ...
    new_OM_catch_list$catch$catch <- new_OM_catch_list$catch$catch * tmp_catch$catch_bias 
  }
  if(!is.null(new_OM_catch_list$catch_bio)){
    ...
    new_OM_catch_list$catch_bio$catch <- new_OM_catch_list$catch_bio$catch * tmp_catch_bio$catch_bias
  }
