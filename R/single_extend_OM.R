            ...
            if(temp_ctl[current_par,c("dev_link")]!=2 & temp_ctl[current_par,c("dev_link")]!=22){
              ...
              if(is.element(temp_ctl[current_par,c("dev_link")], c(1,21))){
                ...
                if(temp_ctl[current_par,c("env_var&link")] > 0){
                  ...
                  env_dat <- datlist[["envdat"]][is.element(datlist[["envdat"]][,"Yr"],base_dev_years) & datlist[["envdat"]][,"Variable"]==env_index,]
              ...
              }else if(is.element(temp_ctl[current_par,c("dev_link")], c(2,23))){
                ...
                {
                  scale_devs[j] <- new_par_tv[(length(new_par_tv[,1])),"ESTIM"]*scale_devs[j-1]+scale_devs[j]
