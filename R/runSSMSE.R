...
run_SSMSE <- function(scen_name_vec,
                      ...
                      MS_vec = c("EM", "no_catch", "custom", "Interim"),
  ...
  if(!all(MS_vec %in% c("EM", "no_catch", "custom", "Interim"))) {
    stop("MS_vec can only include 'EM', 'no_catch', 'custom', or 'Interim'.")
  }
  ...
  scen_list <- create_scen_list(scen_name_vec = scen_name_vec,
                                ...
                                MS_vec = MS_vec,
                                MS_custom_name_vec = MS_custom_name_vec,
...
run_SSMSE_iter <- function(out_dir = NULL,
  ...
  new_catch_list <- parse_MS(MS = MS, MS_custom_name = MS_custom_name, 
                             EM_out_dir = EM_out_dir, init_loop = TRUE,
